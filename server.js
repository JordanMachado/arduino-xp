...
app.post('/', function (req, res) {
  ...
  //write image
  require("fs").writeFile("./users-images/out"+imageNumber+".png", base64Data, 'base64', function(err) {
      var data = require('fs').readFileSync('./users-images/out'+imageNumber+'.png');
      T.post('media/upload', {media: data}, function(error, media, response){

        if (!error) {
          // write tweet
          var status = {
            status: 'Hey I just took a pic with #ROTOPHOTO #CRMAXVI',
